...
JAVA_BOT = "java -cp out/production/connect-four-java com.hitechbunny.Main"
JAVA_OTHER_BOT = "java -cp bot-v11.jar com.hitechbunny.Main"
RUBY_BOT = "ruby bot.rb"

wins = {1 => 0, 2 => 0}
RUNS=25
1.upto(RUNS) do
Open3.popen2(JAVA_OTHER_BOT) do |o1,i1,t1|
# Open3.popen3(JAVA_BOT) do |o1,i1,e1,t1|
  # Open3.popen3(JAVA_OTHER_BOT) do |o2,i2,e2,t2|
  Open3.popen2(JAVA_BOT) do |o2,i2,t2|
